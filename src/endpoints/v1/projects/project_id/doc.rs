...
use crate::endpoints::v1::projects::project_id::patch::endpoint::__path_update_project;
...
#[derive(OpenApi)]
#[openapi(
    paths(close_project, delete_project, get_project, update_project),
    components(schemas(GetProjectResultView, UpdateProjectView))
)]
struct Doc;
